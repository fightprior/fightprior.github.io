...
```{r mcmc_alpha_est, cache = TRUE, message = FALSE}
...
```{r method_table, fig.height = 8, fig.width = 15}
...
ggtern(value_grid, aes(x = Dec, y = `KO/TKO`, z = Sub)) +
  ...
  geom_point(data = method_breakdown_summary, aes(color = n), size = 0.5) +
