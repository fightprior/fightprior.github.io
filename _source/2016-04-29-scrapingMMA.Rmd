...
Looking at this log-log scatter plot of # of bouts in each fighter's career, it is clear that the majority of fighters have very short careers. Only `r fight_counts %>% filter(n > 10) %>% nrow` fighters have fought in more than 10 MMA bouts. 
